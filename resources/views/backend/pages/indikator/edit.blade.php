                                          ...
                                          <div class="card-body">
                                            <form method="POST" action="{{route('indikator.update', [$indikator->id])}}">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" value="{{ old('name', isset($indikator) ? $indikator->name : '') }}">
                                              </div>
                                              <div class="form-group">
                                                <label for="exampleInputEmail1">Nilai</label>
                                                <input type="text" class="form-control" name="nilai" value="{{ old('nilai', isset($indikator) ? $indikator->nilai : '') }}">
                                              </div>
                                              <hr class="pt-3">
